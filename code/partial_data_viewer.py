...
def _parser_args():
    ...
    parser.add_argument('--max_dataset_num', type=int, help="Since the total dataset is too large, so we instead search for the first several data", default=100)
...
def main():
    ...
    for dataset_type in tqdm(args.dataset_types):
        ...
        subset_dataset = list(dataset.take(args.max_dataset_num))
